// ======================================================================
// \title  GPSDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef GPSDEPLOYMENT_GPSDEPLOYMENTTOPOLOGY_HPP
#define GPSDEPLOYMENT_GPSDEPLOYMENTTOPOLOGY_HPP
// Included for access to GPSDeployment::TopologyState and GPSDeployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <GPSDeployment/Top/GPSDeploymentTopologyDefs.hpp>

// Remove unnecessary GPSDeployment:: qualifications
using namespace GPSDeployment;
namespace GPSDeployment {
/**
 ...
 * GPSDeployment::TopologyState see: GPSDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type GPSDeployment::TopologyState see: GPSDeploymentTopologyDefs.hpp.
 *
