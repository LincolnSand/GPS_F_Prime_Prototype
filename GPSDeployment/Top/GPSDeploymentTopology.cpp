...
#include <GPSDeployment/Top/GPSDeploymentTopologyAc.hpp>
#include <GPSDeployment/Top/GPSDeploymentPacketsAc.hpp>
...
void configureTopology() {
    ...
    // tlmSend.setPacketList(GPSDeploymentPacketsPkts, GPSDeploymentPacketsIgnore, 1);
...
// Public functions for use in main program are namespaced with deployment name GPSDeployment
...
void startSimulatedCycle(U32 milliseconds) {
    ...
    // Main loop
    while (cycling) {
        GPSDeployment::blockDrv.callIsr();
