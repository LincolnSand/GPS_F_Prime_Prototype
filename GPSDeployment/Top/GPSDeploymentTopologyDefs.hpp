// ======================================================================
// \title  GPSDeploymentTopologyDefs.hpp
// \brief required header file containing the required definitions for the topology autocoder
//
// ======================================================================
#ifndef GPSDEPLOYMENT_GPSDEPLOYMENTTOPOLOGYDEFS_HPP
#define GPSDEPLOYMENT_GPSDEPLOYMENTTOPOLOGYDEFS_HPP

#include "Drv/BlockDriver/BlockDriver.hpp"
#include "Fw/Types/MallocAllocator.hpp"
#include "GPSDeployment/Top/FppConstantsAc.hpp"
 ...
 *
 * The topology autocoder requires an object that carries state with the name `GPSDeployment::TopologyState`. Only the type
