...
#include <GPSDeployment/Top/GPSDeploymentTopology.hpp>
...
static void signalHandler(int signum) {
    GPSDeployment::stopSimulatedCycle();
}
...
int main(int argc, char* argv[]) {
    ...
    GPSDeployment::TopologyState inputs;
    ...
    GPSDeployment::setupTopology(inputs);
    GPSDeployment::startSimulatedCycle(1000);  // Program loop cycling rate groups at 1Hz
    GPSDeployment::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
