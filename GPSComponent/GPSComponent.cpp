...
#include "GPSComponent/GPSComponent.hpp"
...
namespace Components {
  ...
  GPSComponent ::
    ...
    ) : GPSComponentComponentBase(compName),
  ...
  {
    GPSComponentComponentBase::init(queueDepth, instance);
  }
    ...
    )
  {
    ...
    if (status != Drv::RecvStatus::RECV_OK) {
    ...
    )
  {
    ...
    this->serialBufferOut_out(0, cmdBuffer);
